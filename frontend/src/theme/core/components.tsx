...
declare module '@mui/material/styles' {
  ...
  // Fix for fontWeightSemiBold - ensure all declarations have identical modifiers
...
const MuiCheckbox: Components<Theme>['MuiCheckbox'] = {
  defaultProps: {
    ...
    icon: (
      <SvgIcon>
        <path d="M17.9 2.318A5 5 0 0 1 22.895 7.1l.005.217v10a5 5 0 0 1-4.783 4.995l-.217.005h-10a5 5 0 0 1-4.995-4.783l-.005-.217v-10a5 5 0 0 1 4.783-4.996l.217-.004h10Z" />
      </SvgIcon>
    ),
    checkedIcon: (
      <SvgIcon>
...
export const theme = createTheme({
  ...
  customShadows: {
    card: '0px 12px 24px rgba(0,0,0,0.12)',
  },
  palette: {
    background: {
      neutral: '#F5F5F5',
