  ...
  const defaultStyles: CSSObject = {
    ...(color === 'default' && {
      ...
      ...(variant === 'soft' && {
        ...
        // Fix: Use fallback for channel property
        backgroundColor: varAlpha(
          (theme.vars?.palette.grey as any)['500Channel'] || theme.vars?.palette.grey[500] || '#9e9e9e',
          0.16
        ),
      }),
      /**
    ...
    ...(color &&
      color !== 'default' && {
        ...
        ...(variant === 'soft' && {
          ...
          // Fix: Use fallback for mainChannel property
          backgroundColor: varAlpha(
            (theme.vars?.palette[color] as any)?.mainChannel || 
         ...
         */
        ...(variant === 'inverted' && {
          // Fix: Use 'dark' instead of 'darker' and 'light' instead of 'lighter'
          color: theme.vars?.palette[color]?.dark,
